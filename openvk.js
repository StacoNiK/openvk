...
var openVK = (function () {
    ...
    // The VK App Id. Required. Set using init().
        fbAppId,
    ...
    // Default OAuth redirect URL. Can be overriden in init()
        oauthRedirectURL = baseURL + 'https://oauth.vk.com/blank.html',

    // Default Cordova OAuth redirect URL. Can be overriden in init()
        cordovaOAuthRedirectURL = "https://oauth.vk.com/blank.html",

    // Default Logout redirect URL. Can be overriden in init()
        logoutRedirectURL = baseURL + 'https://oauth.vk.com/blank.html',
    ...
    /**
     * Initialize the OpenVK module. You must use this function and initialize the module with an appId before you can
     * use any other function.
     * @param params - init paramters
     *  appId: (Required) The id of the VK app,
     *  tokenStore: (optional) The store used to save the VK token. If not provided, we use sessionStorage.
     *  loginURL: (optional) The OAuth login URL.
     *  logoutURL: (optional) The logout URL.
     *  oauthRedirectURL: (optional) The OAuth redirect URL.
     *  cordovaOAuthRedirectURL: (optional) The OAuth redirect URL.
     *  logoutRedirectURL: (optional) The logout redirect URL. 
    ...
    /**
     * Login to VK using OAuth. If running in a Browser, the OAuth workflow happens in a a popup window.
     * If running in Cordova container, it happens using the In-App Browser. Don't forget to install the In-App Browser
     * plugin in your Cordova project: cordova plugins add org.apache.cordova.inappbrowser.
     *
     * @param callback - Callback function to invoke when the login process succeeds
     * @param options - options.scope: The set of VK permissions requested
     * @returns {*}
     */
    function login(callback, options) {
        ...
        if (!fbAppId) {
            return callback({status: 'unknown', error: 'VK App Id not set.'});
        }
     ...
     * @param url - The oautchRedictURL called by VK with the access_token in the querystring at the ned of the
     * OAuth workflow.
     */
    function oauthCallback(url) {
        // Parse the OAuth data received from VK
        var queryString,
            obj;
    ...
    /**
     * Logout from VK, and remove the token.
     * IMPORTANT: For the VK logout to work, the logoutRedirectURL must be on the domain specified in "Site URL" in your Facebook App Settings
     *
     */
    ...
    /**
     * Lets you make any VK API request.
     * @param obj - Request configuration object. Can include:
     *  method:  HTTP method: GET, POST, etc. Optional - Default is 'GET'
     *  path:    path in the VK: users.get, etc. - Required
    ...
    function api(obj) {
        ...
        url = 'https://api.vk.com/method/' + obj.path + '?' + toQueryString(params);
